...
if __name__ == "__main__":
    ...
    whatsapp_detector = Thread(target=packet_sniff, args=(q_packet_detector,notifier))
    whatsapp_controller = Thread(target=whatsapp_controller, args=(q_timer,notifier))
